...
#define ItemTag   32200
#define BadgeTag  32400
...
-(void)showBadgeAtIndex:(NSInteger)index{
    ...
    HLTabbarButton *itemView = (HLTabbarButton*)[self viewWithTag:ItemTag+index];
...
-(void)btnClicked:(HLTabbarButton*)btn{
    ...
    self.selectedIndex = btn.tag - ItemTag;
}
...
-(void)setSelectedIndex:(NSInteger)selectedIndex{
    ...
    self.selBtn.selected = NO;
    HLTabbarButton *btn  = (HLTabbarButton*)[self viewWithTag:ItemTag+selectedIndex];
    btn.selected = YES;
...
-(void)setSelectedItemColor:(UIColor *)selectedItemColor{
    ...
    for (int i = 0; i<self.sourceArr.count; i++) {
        HLTabbarButton *btn  = (HLTabbarButton*)[self viewWithTag:ItemTag+i];
