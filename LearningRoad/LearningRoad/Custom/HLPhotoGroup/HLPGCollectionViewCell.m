...
@interface HLPGCollectionViewCell ()
@end

@implementation HLPGCollectionViewCell
...
+(instancetype)PhotoCollectionViewCellWithCollectionView:(UICollectionView*)collectionView IndexPath:(NSIndexPath*)indexPath{
    ...
    HLPGCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellName forIndexPath:indexPath];
