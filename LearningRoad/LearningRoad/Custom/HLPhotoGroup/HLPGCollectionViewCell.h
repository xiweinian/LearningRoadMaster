...
@protocol HLPGCollectionViewCellDelegate <NSObject>
@optional
-(void)photoDeleteClick:(UIButton*)btn;
@end

@interface HLPGCollectionViewCell : UICollectionViewCell
@property (nonatomic,assign)id<HLPGCollectionViewCellDelegate>delegate;
